...
Command: npx gltfjsx@6.1.4 -T public/model2.glb
*/
  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[0, Math.PI / 2, 0]} scale={0.1}>
        ...
        <mesh geometry={nodes.mesh_1.geometry} material={nodes.mesh_1.material} rotation={[Math.PI / 2, 0, 0]} />
        <mesh geometry={nodes.mesh_2.geometry} material={nodes.mesh_2.material} rotation={[Math.PI / 2, 0, 0]} />
        <mesh geometry={nodes.mesh_3.geometry} material={nodes.mesh_3.material} rotation={[Math.PI / 2, 0, 0]} />
        <mesh geometry={nodes.mesh_4.geometry} material={nodes.mesh_4.material} rotation={[Math.PI / 2, 0, 0]} />
        <mesh geometry={nodes.mesh_5.geometry} material={nodes.mesh_5.material} rotation={[Math.PI / 2, 0, 0]} />
